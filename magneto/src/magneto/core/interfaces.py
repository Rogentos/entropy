...
class MagnetoCore(MagnetoCoreUI):
    ...
    def __init__(self, main_loop_class):
        ...
        self._menu_item_list = (
            ...
            ("web_site", _("_Argent Linux Website"),
                _("Launch Argent Linux Website"), self.load_website),
            None,
    ...
    def show_service_not_available(self):
        ...
        self.show_alert(
            _("Cannot monitor Argent updates"),
            "%s: %s: %s" % (
    ...
    def new_updates_signal(self, update_atoms, one_click_update=False):
        ...
        if upd_len:
            ...
            # all fine, no updates
            self.update_tooltip(_("Your Argent is up-to-date"))
            self.set_state("OKAY")
            self.show_alert(_("Your Argent is up-to-date"),
    ...
    def updating_signal(self):
        ...
        self.show_alert(_("Argent repositories status"),
